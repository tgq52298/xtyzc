...
$cfg_basehost = 'http://www.yxycf.top';
$cfg_cmspath = '';
$cfg_cookie_encode = '48wlg7P6ceBumdfRLencQngT5DclW0M8';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '安岳县小唐养殖场';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2016-2036 永鲜源水产养殖鱼场';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_mb_rmdown = 'Y';
$cfg_cli_time = 8;
$cfg_mb_addontype = 'swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov|zip|rar|doc|xsl|ppt|wps|mp4';
$cfg_mb_max = 500;
$cfg_keyword_like = 'N';
$cfg_index_max = 10000;
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '安岳县小唐养殖场、小唐养殖场、安岳小唐养殖场、李家小唐养殖场、养殖场、';
$cfg_description = '安岳县小唐养殖场、小唐养殖场、安岳小唐养殖场、李家小唐养殖场、养殖场、';
$cfg_beian = '蜀ICP备20017086号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
...
$cfg_tel = '13508040392';
$cfg_shijian = '工作时间：周一到周天 AM8:00';
$cfg_ggtxet = '诚信为本，市场在变，诚信永远不变...';
$cfg_adr = '四川省资阳市安岳县李家镇关上村5组  ';
$cfg_email = '1926610908@QQ.com';
$cfg_fax = '13508040392';
$cfg_zuobiao = '105.502785,29.852792';
?>